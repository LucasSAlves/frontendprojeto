        ...
        if(!usuario.id){
          usuarioService.inserir(usuario)
            ...
            .then((response) => {
                ...
                const msg = error?.response?.data?.message || 'Erro ao alterar.';
                toast.current?.show({
                    severity: 'error',
                    summary: 'Erro!',
                    detail: msg
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={usuarioDialog} style={{ width: '450px' }} header="Detalhes de usário" modal className="p-fluid" footer={usuarioDialogFooter} onHide={hideDialog}>
                    ...
                    <Dialog visible={deleteUsuariosDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deleteUsuariosDialogFooter} onHide={hideDeleteUsuariosDialog}>
                        <div className="flex align-items-center justify-content-center">
                            <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                            {selectedUsuarios && <span>Tem certeza que deseja excluir os usuários selecionados?</span>}
                        </div>
                    </Dialog>
                </div>
            </div>
